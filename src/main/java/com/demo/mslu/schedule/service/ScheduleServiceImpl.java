...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public String getWeek(@NotNull ScheduleRequest scheduleRequest) {
        scheduleRequest.setWeek(scheduleRequest.getWeek() + calculateWeek());
        return getConvertedDay(scheduleRequest, MONDAY) +
                getConvertedDay(scheduleRequest, TUESDAY) +
                getConvertedDay(scheduleRequest, WEDNESDAY) +
                getConvertedDay(scheduleRequest, THURSDAY) +
                getConvertedDay(scheduleRequest, FRIDAY) +
                getConvertedDay(scheduleRequest, SATURDAY);
    }
